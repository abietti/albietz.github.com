...
I obtained my [PhD](http://pascal.inrialpes.fr/data2/abietti/thesis.pdf) in November 2019 from Inria and Université Grenoble-Alpes, where I worked in the [Thoth team](http://thoth.inrialpes.fr/) on machine learning and optimization under the supervision of [Julien Mairal](http://thoth.inrialpes.fr/people/mairal/), funded by the [MSR-Inria joint center](http://www.msr-inria.fr/).
